...
public class Test2 {
    public static void main(String args []) throws Exception {
        ...
        String [] filename = new File("cana").list();
        ...
        for (int i = 0; i < filename.length; i++) {
            ...
            File file = new File("cana/"+filename[i]);
        ...
        System.out.println((double)(1.0*counttaiwan/filename.length));
        System.out.println("right:"+counttaiwan);
        System.out.println("wrong:"+countspain);
        jedis.close();
    }
}
